...
public class ProcessProcedure {
	...
	/**
	 * 检查是否移交原路返回，如果sExecuteMode2 == flowToFront表示需要原路返回，设置
	 * 
	 * @author tkj
	 * @param pi
	 */
	...
	public static void transferTask(String task, ProcessControl control) {
		...
		while (i.hasNext()) {
			...
			if (n.activation()) {
				...
				KSQL.executeUpdate("update SA_Task t set t.sStatusID=:sStatusID,t.sStatusName=:sStatusName where t=:id or t.sParent=:id", params,
						"/system/data", null);
			}
		}
